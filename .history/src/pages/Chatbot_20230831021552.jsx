...
const ChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      message: "👋🏻 Hi, I am GPTAudioCraft! How can I help you?",
      sentTime: "just now",
      sender: "ChatGPT",
      role: "system",
    },
  ...
  async function sendMessage(chatMessages) {
    ...
    const systemMessage = {
      role: "system",
      content:
        "You are an AI Assistant chatbot of GPTAudioCraft a website that helps users to generate audio files powered by Audiocraft GenAI created by meta. Audiocraft is a library for audio processing and generation with deep learning. It features the state-of-the-art EnCodec audio compressor / tokenizer, along with MusicGen, a simple and controllable music generation LM with textual and melodic conditioning. Answer as short and concise as possible",
    };
      ...
      <div className="h-24 py-5 text-center text-white bg-gradient-to-r from-sky-500 to-blue-600 rounded-lg ">
        <div className="flex items-center justify-center t">
          ...
          <h2 className="text-white px-2 font-bold text-xl">
            GPTAudioCraft<span className="font-normal">Bot</span>
          </h2>
        </div>
        <div>
        ...
        <MainContainer className="md:h-full border-0">
          <ChatContainer>
            <MessageList
              ...
              typingIndicator={
                typing ? (
                  <TypingIndicator content="GPTAudioCraftBot is typing" />
                ) : null
              }
