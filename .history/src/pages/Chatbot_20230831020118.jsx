...
const ChatBot = () => {
  ...
  async function sendMessage(chatMessages) {
    ...
    const systemMessage = {
      role: "system",
      content:
        "You are an AI Assistant chatbot of GPTAudioCraft a website that helps users to generate audio files powered by audiocraft genai created by meta. Answer as short and concise as possible",
    };
